package com.exa.unicen.arbolado.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.exa.unicen.arbolado.service.EmailAlreadyUsedException ||
            ex instanceof com.exa.unicen.arbolado.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.exa.unicen.arbolado.service.InvalidPasswordException
